...
& 0xff) << 24);
		...
		getIEPluginsString: function() {
			if (window.ActiveXObject) {
				var names = ['ShockwaveFlash.ShockwaveFlash', 'AcroPDF.PDF', 'PDF.PdfCtrl', 'QuickTime.QuickTime', 'rmocx.RealPlayer G2 Control', 
...
'WMPlayer.OCX', 'AgControl.AgControl', 'Skype.Detection'];
		...
		getCanvasFingerprint: function() {
			...
			var txt = 'http://www.scienmedia.com';
